...
user function RGERARQ()

	Private cVBPerg := 'ARQBENEF'

	Pergunte(cVBPerg,.F.)

	TNewProcess():New("BENEFARQ", STR0001, {|oSelf| ProcessBnf(oSelf)}, STR0002, "ARQBENEF", NIL, NIL, NIL, NIL, .T., .F.) // "Exportacao dos arquivos de beneficios" - "Esta rotina processa e gera arquivo de beneficios para integracao"
...
USER Function BenefValid(cChave)
