...
//============================================================
	If !Empty(AK1->AK1_VERREV)
		Alert("O Orçamento está em revisão portanto as alterações estão bloqueadas. Para alterar utilize o controle de revisão - opção revisar.  ")
		_cErro	+=	"O Orçamento está em revisão portanto as alterações estão bloqueadas. Para alterar utilize o controle de revisão - opção revisar.  "
		Return
	Endif
...
//	EndIf
	...
	//TODO parei na validaão da tabela Ak3 pois não esta gravando a estrutura correta 
		If _lLinValid
			DbSelectArea("AK3")
			ak3->(DbSetOrder(2))
	...
	dbSelectArea("AKB")
	dbSetOrder(1)
	//TODO Johny wendel no cadastro do ponto de lançamento 000252- 01 o campo AKB_PERMR tera que estar = 1
	// para que sejá lançado os lançamentos na tabela AKD
...
//TODO analisar inclussão na AKD
