...
Static Function ReportDef()
	...
	TRCell():New( oSection1, 'TMP_DESCFU'		            ,'T01', 'Desc. Função'               ,			    		""						,30)
	...
	TRCell():New( oSection1, 'TMP_CLVALE'	    	    ,'T01', 'Classificação Vale'                 ,			    		""						,40)
	...
	TRCell():New( oSection1, 'TMP_QTVAL'	    	    ,'T01', 'Qtd. Total Vale Mês'         ,			    		""						,15)
...
Static Function Query( aSection1, aSection2, aSection3, aSection4,aVLR1,aVLR2,aVLR3,aVLR4 )
	...
	(CALIAS1)->(Reclock( CALIAS1, .T.))
		...
		(CALIAS1)->TMP_CLVALE := "CESTA BÁSICA"
